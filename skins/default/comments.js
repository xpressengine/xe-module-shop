/**
 * Manages the comments AJAX editor
 * @author Dan Dragan
 */
...
function loadCommentForm(document_srl)
{
    ...
    if (loadComment)
    {
        ...
        exec_xml('shop','dispCommentEditor', params, showCommentEditor, new Array('error', 'message', 'html'));
    }
...
function doDeleteComment(comment_srl)
{
    ...
    exec_xml('shop','procShopCommentItemDelete', params, function()
    {
...
function modifyCommentForm(comment_srl)
{
    ...
    if (loadComment)
    {
        ...
        exec_xml('shop','dispModifyComment', params, showModifyCommentForm, new Array('error', 'message', 'html', 'comment_srl'));
    }
...
function replyCommentForm(comment_srl)
{
    ...
    if (loadComment)
    {
        ...
        exec_xml('shop','dispReplyComment', params, showReplyCommentEditor, new Array('error', 'message', 'html', 'parent_srl'));
    }
